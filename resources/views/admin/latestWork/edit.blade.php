    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card my-4">
                ...
                <div class="card-body">
                    <form id="productForm" action="{{ route('admin.latest-works.update', ['id' => $work->id]) }}"
                        method="POST">
                        @csrf
                        @method('PUT')
                        <!-- Product Information Section -->
                        <div class="modal-header">
                            <h5 class="modal-title" id="">Edit Latest Work</h5>
                        </div>
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="category" class="form-label">Category</label>
                                <select name="category" id="category" class="form-control" required>
                                    <option @selected($work->category == 'interior') value="interior">Interior</option>
                                    <option @selected($work->category == 'exterior') value="exterior">Exterior</option>
                                </select>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <img src="{{isset($work->image_path) ? asset('storage/' . $work->image_path) : url('/images/default.jpg')}}"
                        ...
                        <section class="mb-4">
                            ...
                            <div class="mb-3 d-flex">
                                ...
                                <div class="d-flex flex-column w-sm-20">
                                    <img src="{{isset($image->image) ? asset('storage/' . $image->image) : url('/images/default.jpg')}}"
                                        id="currentImage" alt="Detail Image" class="img-thumbnail m-auto" style="width: 100px;">
