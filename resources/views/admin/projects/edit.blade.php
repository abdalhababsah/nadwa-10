    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card my-4">
                ...
                <div class="card-body"><form id="productForm" action="{{ route('admin.projects.update', ['id' => $work->id]) }}" method="POST">
    @csrf
    @method('PUT')
    ...
    <div class="modal-body">
        <div class="mb-3">
            ...
            <select name="category" id="category" class="form-control" required>
                ...
                <option value="{{$category->value}}" @selected($category == old('category', $work))>{{$category->name}}</option>
                @endforeach
            </select>
